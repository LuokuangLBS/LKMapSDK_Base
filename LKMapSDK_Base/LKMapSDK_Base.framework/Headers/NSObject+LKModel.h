 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `LKModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface LKAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation LKAuthor
     @end
 
     @interface LKBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) LKAuthor *author;
     @end
     @implementation LKBook
     @end
    
     int main() {
         // create model from json
         LKBook *book = [LKBook lk_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book lk_modelToJSONString];
 ...
 @code
     @interface LKShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation LKShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self lk_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self lk_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self lk_modelCopy]; }
     - (NSUInteger)hash { return [self lk_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self lk_modelIsEqual:object]; }
     @end
 @endcode
 ...
 */
+ (nullable instancetype)lk_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)lk_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)lk_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)lk_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)lk_modelToJSONObject;
 ...
 */
- (nullable NSData *)lk_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)lk_modelToJSONString;
 ...
 */
- (void)lk_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)lk_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
+ (nullable NSArray *)lk_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
+ (nullable NSDictionary *)lk_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<LKModel>' to your class header.
 */
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class LKShadow, LKBorder, LKAttachment;
 
        @interface LKAttributes
        @property NSString *name;
        ...
        @implementation LKAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [LKShadow class],
                     @"borders" : LKBorder.class,
                     @"attachments" : @"LKAttachment" };
        }
        @end
  @endcode
...
/**
 ...
 Example:
 @code
        @class LKCircle, LKRectangle, LKLine;
 
        @implementation LKShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [LKCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [LKRectangle class];
